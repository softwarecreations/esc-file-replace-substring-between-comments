...
export const fileReplaceSubstringBetweenComments = (path, purpose, newContents, ifNotFound, changedLogF, notFoundLogF, unchangedLogF) => {
	const startComment=`#${purpose} starts`, endComment=`#${purpose} ends`, searchRegex=RegExp(`${startComment}[\\w\\W]*?${endComment}\n`);
	return fileReplaceSubstring(path, searchRegex, `${startComment}\n${newContents}\n${endComment}\n`, ifNotFound, changedLogF, notFoundLogF, unchangedLogF);
};
